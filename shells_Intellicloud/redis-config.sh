#!/usr/bin/env bash
CLUSTER_IP_1=`cat /root/shells/ip.txt | grep redis | grep redis_redis1 | awk -F':' '{print $2}'`
CLUSTER_IP_2=`cat /root/shells/ip.txt | grep redis | grep redis_redis2 | awk -F':' '{print $2}'`
CLUSTER_IP_3=`cat /root/shells/ip.txt | grep redis | grep redis_redis3 | awk -F':' '{print $2}'`
PORT_1="6379"
PORT_2="6380"
PORT_3="6381"
...
ip_pre="10.10.1."
ip_start=`cat /root/shells/ip.txt | grep redis | grep redis_redis1 | awk -F':' '{print $2}' | awk -F'.' '{print $4}'`
ip_end=`cat /root/shells/ip.txt | grep redis | grep redis_redis3 | awk -F':' '{print $2}' | awk -F'.' '{print $4}'`
port_start="6379"
port_end="6381"
